...
export const loader: LoaderFunction = async ({ params }) => {
  ...
  const response = await getProject(params.projectSlug, "cn");
...
export default function Index() {
  ...
  return (
    <Layout theme={"text-white"} footer={true} hover={true} lang={"cn"}>
